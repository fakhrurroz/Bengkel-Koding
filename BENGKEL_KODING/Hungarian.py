...
# -----------------------------------------------------
model = pickle.load(open("BENGKEL_KODING/Model/rf_model.pkl", 'rb'))
...
# Menggunakan tema kustom dengan warna yang konsisten
primaryColor="#F63366"
...
with tab1:
  ...
  predict_btn = st.button("Predict", help="Click to predict the outcome")
...
st.markdown('<p class="big-font">Hungarian Heart Disease</p>', unsafe_allow_html=True)
